...
completion with multiple search keywords by use of space or comma as the
...
- [[var:+orderless-wildcard-character]] ::
  Used for fuzzy-matching corfu invocations as an escapable alternative to ~corfu-separator~.
